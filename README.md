...
> Desenvolvedor Back-End com foco em **Oracle APEX**, **PL/SQL** e **Oracle Database**, criando soluções escaláveis e de alta performance para ambientes corporativos. Antes de migrar para o desenvolvimento, passei um ano em **infraestrutura e monitoramento** — o que me deu uma visão sólida de ponta a ponta sobre os ambientes em que minhas aplicações rodam.
...
💼 Beg Support                                         1 ano 11 meses
   ├── 🔷 Oracle APEX Developer          jun/2025 → presente
   │      Desenvolvimento de aplicações web com Oracle APEX,
   │      APIs RESTful, modelagem de dados e otimização SQL
   │
   └── ☁️  Estagiário Cloud Infrastructure  jun/2024 → jun/2025
          Suporte e monitoramento de infraestrutura com
          Zabbix, OCI, Linux e Docker
```
